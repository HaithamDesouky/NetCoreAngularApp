...
namespace API.Controllers
{
  ...
  public class MessagesController : BaseApiController
  {
    ...
    [HttpPost]
    public async Task<ActionResult<IEnumerable<MessageDto>>> GetMessagesForUser(CreateMessageDto createMessageDto)
    {
      ...
      var recepient = await _userRepository.GetUserByUsernameAsync(createMessageDto.RecipientUsername);
        ...
        [HttpGet("thread/{username}")]
         ...
         public async Task<ActionResult<IEnumerable<MessageDto>>> GetMessageThred(string username)
        {
    ...
    //     _userRepository.DeleteMessage(message);
